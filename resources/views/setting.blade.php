...
@section('container')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Pengaturan Banner</h1>
        </div>
                ...
                <div class="row mt-5">
                    <div class="col-md-4">
                        @if ($setting[0]->image1 == null)
                            <img src="https://ptsse.co.id/assets/gambar_galeri/default.png" alt="" width="100%"
                                height="200">
                        @else
                    ...
                    <div class="col-md-4">
                        @if ($setting[0]->image2 == null)
                            <img src="https://ptsse.co.id/assets/gambar_galeri/default.png" alt="" width="100%"
                                height="200">
                        @else
                            <img src="{{ asset('storage/' . $setting[0]->image2) }}" class="img-fluid" alt=""
                                srcset="">
                        @endif
                    </div>
                    <div class="col-md-8 d-flex align-setting[0]s-center">
                    ...
                    <div class="col-md-4">
                        @if ($setting[0]->image3 == null)
                            <img src="https://ptsse.co.id/assets/gambar_galeri/default.png" alt="" width="100%"
                                height="200">
                        @else
                            <img src="{{ asset('storage/' . $setting[0]->image3) }}" class="img-fluid" alt=""
                                srcset="">
                        @endif
                    </div>
                    <div class="col-md-8 d-flex align-setting[0]s-center">
